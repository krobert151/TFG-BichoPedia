package com.robertorebolledonaharro.bichoapi.common.error.exeptions.user.controller;

import com.robertorebolledonaharro.bichoapi.common.error.exeptions.user.dto.GETUserProfileDTO;
import com.robertorebolledonaharro.bichoapi.common.error.exeptions.user.dto.GETUserSimpleDTO;
import com.robertorebolledonaharro.bichoapi.common.error.exeptions.user.dto.PUTUserBasicInfoDTO;
